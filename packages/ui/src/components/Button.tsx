  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        secondary: 'bg-bg-tertiary text-text-primary shadow-sm hover:bg-border-subtle',
        ghost: 'hover:bg-bg-tertiary text-text-secondary hover:text-text-primary',
        outline: 'border border-border-subtle bg-transparent text-text-secondary hover:bg-bg-tertiary hover:text-text-primary',
        destructive: 'bg-error text-white shadow-sm hover:bg-error/80',
      },
      size: {
