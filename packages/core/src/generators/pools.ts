...
export const REGION_DATA: Record<CulturalRegion, RegionData> = {
  indian: {
    ...
    cities: ['Mumbai','Delhi','Bangalore','Hyderabad','Chennai','Kolkata','Pune','Ahmedabad','Jaipur','Lucknow','Noida','Gurgaon','Chandigarh','Kochi','Indore','Nagpur','Coimbatore','Bhopal','Vadodara','Thiruvananthapuram','Visakhapatnam','Mysore','Surat','Nashik','Mangalore'],
    countries: [{ name: 'India', code: 'IN' }],
    phoneFormat: '+91 #####-#####',
    addressFormat: (num, street) => `${num}, ${street}, Sector ${Math.floor(Math.random() * 60) + 1}`,
    streets: ['MG Road','Nehru Nagar','Gandhi Chowk','Rajiv Path','Subhash Marg','Patel Nagar','Lajpat Nagar','Tilak Road','Sarojini Nagar','Vasant Kunj','Koramangala','Whitefield','Banjara Hills','Jubilee Hills','Salt Lake','Andheri West','Bandra','Powai','Electronic City','Hitech City','Malviya Nagar','Defence Colony','Indiranagar','Jayanagar','HSR Layout'],
  },
  anglo: {
    maleNames: Names.ANGLO_MALE,
    femaleNames: Names.ANGLO_FEMALE,
    lastNames: Names.ANGLO_SURNAMES,
    cities: ['London','New York','San Francisco','Toronto','Sydney','Boston','Seattle','Austin','Denver','Chicago','Portland','Manchester','Edinburgh','Dublin','Melbourne','Los Angeles','Vancouver','Calgary','Brisbane','Perth','Atlanta','Dallas','Phoenix','Miami','Minneapolis'],
    ...
    streets: ['Oak Street','Maple Avenue','Cedar Lane','Pine Road','Elm Drive','Park Boulevard','Lake View Drive','Highland Avenue','Church Street','Main Street','Broadway','King Street','Queen Street','Victoria Road','Cambridge Way','Wellington Road','Oxford Street','Baker Street','Fleet Street','Piccadilly','Regent Street','Bond Street','Downing Street','Abbey Road','Kensington Road'],
  },
  european: {
    maleNames: Names.EUROPEAN_MALE,
    femaleNames: Names.EUROPEAN_FEMALE,
    lastNames: Names.EUROPEAN_SURNAMES,
    cities: ['Berlin','Munich','Amsterdam','Stockholm','Copenhagen','Zurich','Vienna','Prague','Warsaw','Barcelona','Milan','Rome','Paris','Brussels','Oslo','Helsinki','Geneva','Lisbon','Budapest','Hamburg','Frankfurt','Lyon','Marseille','Naples','Rotterdam','Antwerp','Gothenburg','Malmo','Krakow','Bratislava'],
    ...
    streets: ['Hauptstraße','Bahnhofstraße','Kirchweg','Gartenstraße','Bergstraße','Lindenstraße','Marktplatz','Friedrichstraße','Schillerstraße','Mozartweg','Rue de la Paix','Via Roma','Strandvägen','Kalverstraat','Prinsengracht','Kurfürstendamm','Unter den Linden','Champs-Élysées','Gran Vía','Ringstraße','Piazza Navona','Nowy Świat','Váci utca','Strøget','Rambla'],
  },
  east_asian: {
    maleNames: Names.EAST_ASIAN_MALE,
    femaleNames: Names.EAST_ASIAN_FEMALE,
    lastNames: Names.EAST_ASIAN_SURNAMES,
    cities: ['Tokyo','Osaka','Seoul','Busan','Shanghai','Beijing','Shenzhen','Taipei','Hong Kong','Singapore','Kyoto','Yokohama','Incheon','Hangzhou','Guangzhou','Nanjing','Chengdu','Fukuoka','Daegu','Nagoya','Sapporo','Kobe','Wuhan','Suzhou','Xiamen'],
    ...
    streets: ['Shibuya','Shinjuku','Ginza','Roppongi','Akihabara','Gangnam-daero','Hongdae','Myeongdong','Nanjing Road','Orchard Road','Zhongshan Road','Harajuku','Ikebukuro','Daitabashi','Ebisu','Itaewon','Apgujeong','Jongno','Pudong','The Bund','Wangfujing','Insadong','Shimokitazawa','Nakameguro','Aoyama'],
  },
  latin: {
    maleNames: Names.LATIN_MALE,
    femaleNames: Names.LATIN_FEMALE,
    lastNames: Names.LATIN_SURNAMES,
    cities: ['Mexico City','São Paulo','Buenos Aires','Bogota','Lima','Santiago','Montevideo','Medellin','Guadalajara','Rio de Janeiro','Cartagena','Quito','Cancun','Havana','San Jose','Cusco','Valparaiso','Puebla','Monterrey','Salvador','Fortaleza','Brasilia','Cordoba','Rosario','Barranquilla'],
    ...
    phoneFormat: '+52 ## #### ####',
    addressFormat: (num, street) => `${street} ${num}`,
    streets: ['Avenida Insurgentes','Calle Reforma','Boulevard Juárez','Rua Augusta','Avenida Paulista','Calle Florida','Avenida 9 de Julio','Paseo de la Reforma','Rua Oscar Freire','Calle Madero','Avenida Corrientes','Rua da Consolação','Alameda Central','Avenida Libertador','Calle Serrano','Rua XV de Novembro','Avenida Diagonal','Calle Bolívar','Paseo del Prado','Avenida Providencia','Calle Ocho','Rua Direita','Avenida Atlántica','Calle Mayor','Boulevard Miguel de Cervantes'],
  },
  middle_eastern: {
    maleNames: Names.MIDDLE_EASTERN_MALE,
    femaleNames: Names.MIDDLE_EASTERN_FEMALE,
    lastNames: Names.MIDDLE_EASTERN_SURNAMES,
    cities: ['Dubai','Abu Dhabi','Riyadh','Istanbul','Cairo','Doha','Amman','Beirut','Muscat','Kuwait City','Casablanca','Marrakech','Tunis','Baghdad','Tehran','Ankara','Izmir','Jeddah','Manama','Sharjah','Alexandria','Algiers','Fes','Erbil','Mashhad'],
    ...
    streets: ['Sheikh Zayed Road','Al Wahda Street','King Fahad Road','Tahrir Square','Corniche Road','Hamra Street','Al Khail Road','Jumeirah Beach Road','Al Sadd Street','Istiklal Caddesi','Bağdat Caddesi','Nile Corniche','Mohammed V Boulevard','Hassan II Avenue','Al Olaya Street','King Abdullah Road','Salahuddin Street','Al Maktoum Road','Khalifa Street','Rashid Bin Saeed Street','Qasr Al Nil Street','Talaat Harb Street','Atatürk Caddesi','Ferdowsi Street','Enghelab Avenue'],
  },
  african: {
    maleNames: Names.AFRICAN_MALE,
    femaleNames: Names.AFRICAN_FEMALE,
    lastNames: Names.AFRICAN_SURNAMES,
    cities: ['Lagos','Nairobi','Accra','Johannesburg','Cape Town','Dar es Salaam','Addis Ababa','Kampala','Dakar','Casablanca','Kigali','Abuja','Luanda','Maputo','Kinshasa','Harare','Douala','Kumasi','Durban','Pretoria','Port Harcourt','Ibadan','Mombasa','Lusaka','Windhoek'],
    ...
    phoneFormat: '+234 ### ### ####',
    addressFormat: (num, street) => `${num} ${street}`,
    streets: ['Victoria Island Road','Kenyatta Avenue','Oxford Street','Nelson Mandela Drive','Uhuru Highway','Independence Avenue','Liberation Road','Unity Road','Freedom Way','Heritage Boulevard','Market Street','Marina Road','Airport Road','Ring Road','Moi Avenue','Allen Avenue','Lekki-Epe Expressway','Third Mainland Bridge','Adeola Odeku Street','Herbert Macaulay Way','Ikorodu Road','Awolowo Road','Ozumba Mbadiwe Avenue','Obafemi Awolowo Way','Broad Street'],
  },
};
