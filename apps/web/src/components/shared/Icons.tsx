/**
 * Consistent SVG icon set — all line-style, 24x24 viewBox, currentColor.
 * No emojis. Clean, monochrome, developer-tool aesthetic.
 */
...
export function IconToggle({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconBraces({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconNewline({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M17 18H4v-7" /><polyline points="14 15 17 18 14 21" />
      <path d="M7 4h13v7" />
    </svg>
  );
}
...
/**
 * Category icon map — returns the right icon component for a category ID.
 */
export const CATEGORY_ICONS: Record<string, (props: IconProps) => JSX.Element> = {
  person: IconUser,
  location: IconMapPin,
  finance: IconWallet,
  commerce: IconShoppingCart,
  internet: IconGlobe,
